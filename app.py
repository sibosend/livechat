...
def llm_response(message,nerfreal):
    ...
    #     api_key="sk-194378e48a24456d9f5e274874258578",
    ...
    client = OpenAI(
        # 如果您没有配置环境变量，请在此处用您的API Key进行替换
        # api_key=os.getenv("DASHSCOPE_API_KEY"),
        api_key="application-78d7bfeb361afd5604f0b3bf4faceab1",
        # 填写DashScope SDK的base_url
        base_url="http://www.chasing3d.com:6969/api/application/f780952e-ade8-11ef-9760-0242ac110002",
    )
    ...
    completion = client.chat.completions.create(
        ...
        messages = [{
            'role': '你是德宝艺苑集团旗下产品德宝AI数字人小助手，你的工作是帮助用户解答使用中遇到的问题，用户找你回答问题时，你要把主题放在德宝艺苑集团相关知识上。',
            'content': message
        }],
        stream=True,
